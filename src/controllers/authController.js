...
export async function login(req, res) {
  ...
  try {
    ...
    //se senhaValida for false, senha é inválida
    if (!senhaValida) {
    ...
    res.cookie("token", token, {
      ...
      secure: false, //em produção, coloque true para que só seja permitido setar o cookie quando a requisição for https
      sameSite: "lax", //diz como o modo que o cookie é transferido nas requisições, pode deixar lax é seguro.
